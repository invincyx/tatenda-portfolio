...
export default function Services() {
  return (
    <div className="py-16 px-32 bg-gradient-to-r from-green-50 to-teal-50 ">
       
            <h3 className="mb-4 text-7xl font-extrabold lg:text-5xl text-center  ">Services</h3>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-4 lg:gap-8 py-16">
